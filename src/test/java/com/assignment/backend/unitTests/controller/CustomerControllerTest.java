...
class CustomerControllerTest {
    ...
    void getCustomerByEmail_found() throws Exception {
        ...
        mockMvc.perform(get("/api/customers/search").param("email", "alice@example.com"))
                .andExpect(status().isOk())
    ...
    void patchContactNumber_valid() throws Exception {
        ...
        mockMvc.perform(patch("/api/customers/{id}/contact", testId)
    ...
    void headRequest_shouldReturnOkOrNotFound() throws Exception {
        ...
        mockMvc.perform(head("/api/customers/{id}", testId))
                .andExpect(status().isOk());
    }
